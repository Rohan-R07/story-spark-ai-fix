...
export default function ContributorsComponent() {
  ...
  const totalPRs = totalContributions;
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 md:py-28">
        ...
        <div ref={ctaRef} className="mt-24 md:mt-32">
          ...
          >
            {/* Decorative orbs */}
            <div className="cta-orb absolute top-6 left-10 w-20 h-20 rounded-full bg-indigo-50/10 blur-2xl" />
            <div className="cta-orb absolute bottom-8 right-14 w-28 h-28 rounded-full bg-purple-50/10 blur-2xl" />
